...
//	    }
//	    
		listStudents = crudRepo.findAll().stream().filter(student -> student.getName().equals(name))
	...
	public List<Student> find(Student student) {
		...
		List<Student> filtereList = listStudents.stream()
				.filter(s -> ((s.getName() != null) && (s.getName()
						.equals((student.getName() == null || student.getName().length() == 0) ? s.getName()
								: student.getName())))
						&& ((s.getEmail() != null) && (s.getEmail()
								.equals((student.getEmail() == null || student.getEmail().length() == 0) ? s.getEmail()
										: student.getEmail())))
						&& ((s.getSports() != null) && (s.getSports()
								.equals((student.getSports() == null || student.getSports().length() == 0)
										? s.getSports()
										: student.getSports())))
						&& ((s.getState() != null) && (s.getState()
								.equals((student.getState() == null || student.getState().length() == 0) ? s.getState()
										: student.getState())))
						&& ((s.getRollNo() != null) && (s.getRollNo()
								.equals((student.getRollNo() == null || student.getRollNo().length() == 0)
										? s.getRollNo()
										: student.getRollNo())))
						&& ((s.getSubject() != null) && (s.getSubject()
								.equals((student.getSubject() == null || student.getSubject().length() == 0)
										? s.getSubject()
										: student.getSubject()))))
				.collect(Collectors.toList());
